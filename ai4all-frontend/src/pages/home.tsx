  ...
  const missionSlides = [
    {
      ...
      content:
        "AI4ALL-ի նպատակն է տրամադրել երիտասարդներին կիրառական արհեստական բանականության հմտություններ՝ հնարավորություն տալով նրանց բարգավաճել ստեղծարար, տեխնոլոգիական և բիզնես ոլորտներում։",
      ...
      <section className="bg-gradient-to-br from-purple-900 via-blue-800 to-black px-6 md:px-20 py-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          {newsItems.map((item) => (
            ...
            <div className="relative flex justify-center items-center py-8 mt-32 sm:mt-32 md:mt-28 w-full max-w-xs sm:max-w-md md:max-w-lg mx-auto z-0" style={{ minHeight: '120px', minWidth: '120px' }}>
              ...
              <video
                ...
                muted
                playsInline
                className="w-24 sm:w-32 md:w-64 h-auto relative z-10 mx-auto"
              >
                <source src="/animations/robot.webm" type="video/webm" />
                Your browser does not support the video tag.
              </video>
